...
void sample_input(void)
{
	...
	XX_UIIn.XIFt_IA = os.AIHandle->XIFt_IA*0.5*(-1.0);
	XX_UIIn.XIFt_IC = os.AIHandle->XIFt_IB*0.5*(-1.0);
	...
	LowPass(&hstoda.XIFt_IA_Avg,fabs(XX_UIIn.XIFt_IA),CvCtrl.Duty[0]*PI2*1.0);//一阶滤波 截止频率1Hz
