...
void InitSci(void)
{
	...
	ScibRegs.SCIFFTX.all=0x8000;    // Reset

	ScibRegs.SCICCR.all =0x0007;    
	ScibRegs.SCICTL1.all =0x0001;   // disenable TX,
	ScibRegs.SCICTL2.all = 0x0002;  // Enable RX interrrupt
	ScibRegs.SCIHBAUD = 0x01;
	ScibRegs.SCILBAUD = 0xe7;    // 9600=487=0x01e7   38400=121=0x79

	ScibRegs.SCICTL1.all = 0x0021;
