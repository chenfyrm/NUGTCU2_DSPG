...
volatile struct flagsci_BITS flagsci;//TRSCI
volatile struct s_adc_BITS adc_low;//TRSCI
volatile struct s_dac_REG dac_low;//TRSCI
//----------------------------------------
#ifdef __cplusplus
...
volatile float32 RFFTin1Buff[RFFT_SIZE];                 //RFFT_f32u(optional), RFFT_f32(required)
                                                //Output of FFT overwrites input if 
                                                //RFFT_STAGES is ODD
#pragma DATA_SECTION(RFFToutBuff,"RFFTdata2"); 
volatile float32 RFFToutBuff[RFFT_SIZE];                 //Output of FFT here if RFFT_STAGES is EVEN

#pragma DATA_SECTION(RFFTmagBuff,"RFFTdata3");
volatile float32 RFFTmagBuff[RFFT_SIZE/2+1];             //Additional Buffer used in Magnitude calc
 
#pragma DATA_SECTION(RFFTF32Coef,"RFFTdata4");
volatile float32 RFFTF32Coef[RFFT_SIZE];                 //Twiddle buffer
*/
//===========================================================================
// End of file.
//===========================================================================
